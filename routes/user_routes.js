...
var isAuthenticated = require(__dirname + '/../lib/eat_auth');
var isAuthorized = require(__dirname + '/../lib/eat_authorize');
...
userRouter.put('/update', jsonParser, isAuthenticated, function(req, res) {
...
userRouter.put('/addadmin', jsonParser, isAuthorized, function(req, res) {
